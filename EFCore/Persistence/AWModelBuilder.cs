...
namespace EFCore.Bencher
{
	...
	public partial class AWModelBuilder
	{
		...
		protected virtual void MapAddress(EntityTypeBuilder<Address> config)
		{
			...
			config.HasOne(t => t.StateProvince).WithMany(t => t.Addresses).HasForeignKey(t => t.StateProvinceId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapBillOfMaterial(EntityTypeBuilder<BillOfMaterial> config)
		{
			...
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Product).WithMany(t => t.BillOfMaterials).HasForeignKey(t => t.ComponentId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.Product_).WithMany(t => t.BillOfMaterials_).HasForeignKey(t => t.ProductAssemblyId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.UnitMeasure).WithMany(t => t.BillOfMaterials).HasForeignKey(t => t.UnitMeasureCode).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapBusinessEntityAddress(EntityTypeBuilder<BusinessEntityAddress> config)
		{
			...
			config.Property(t => t.Rowguid).HasColumnName("rowguid");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Address).WithMany(t => t.BusinessEntityAddresses).HasForeignKey(t => t.AddressId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.AddressType).WithMany(t => t.BusinessEntityAddresses).HasForeignKey(t => t.AddressTypeId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.BusinessEntity).WithMany(t => t.BusinessEntityAddresses).HasForeignKey(t => t.BusinessEntityId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapBusinessEntityContact(EntityTypeBuilder<BusinessEntityContact> config)
		{
			...
			config.Property(t => t.Rowguid).HasColumnName("rowguid");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.BusinessEntity).WithMany(t => t.BusinessEntityContacts).HasForeignKey(t => t.BusinessEntityId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.ContactType).WithMany(t => t.BusinessEntityContacts).HasForeignKey(t => t.ContactTypeId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.Person).WithMany(t => t.BusinessEntityContacts).HasForeignKey(t => t.PersonId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapContactCreditCard(EntityTypeBuilder<ContactCreditCard> config)
		{
			...
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.CreditCard).WithMany(t => t.ContactCreditCards).HasForeignKey(t => t.CreditCardId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.Person).WithMany(t => t.ContactCreditCards).HasForeignKey(t => t.ContactId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapCountryRegionCurrency(EntityTypeBuilder<CountryRegionCurrency> config)
		{
			...
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.CountryRegion).WithMany(t => t.CountryRegionCurrencies).HasForeignKey(t => t.CountryRegionCode).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.Currency).WithMany(t => t.CountryRegionCurrencies).HasForeignKey(t => t.CurrencyCode).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapCurrencyRate(EntityTypeBuilder<CurrencyRate> config)
		{
			...
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Currency).WithMany(t => t.CurrencyRates).HasForeignKey(t => t.FromCurrencyCode).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.Currency_).WithMany(t => t.CurrencyRates_).HasForeignKey(t => t.ToCurrencyCode).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapCustomer(EntityTypeBuilder<Customer> config)
		{
			...
			config.Property(t => t.Rowguid).HasColumnName("rowguid");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Person).WithMany(t => t.Customers).HasForeignKey(t => t.PersonId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.SalesTerritory).WithMany(t => t.Customers).HasForeignKey(t => t.TerritoryId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.Store).WithMany(t => t.Customers).HasForeignKey(t => t.StoreId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapDocument(EntityTypeBuilder<Document> config)
		{
			...
			config.Property(t => t.Rowguid).HasColumnName("rowguid");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Employee).WithMany(t => t.Documents).HasForeignKey(t => t.Owner).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapEmailAddress(EntityTypeBuilder<EmailAddress> config)
		{
			...
			config.Property(t => t.Rowguid).HasColumnName("rowguid");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Person).WithMany(t => t.EmailAddresses).HasForeignKey(t => t.BusinessEntityId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapEmployee(EntityTypeBuilder<Employee> config)
		{
			...
			config.Property(t => t.Rowguid).HasColumnName("rowguid");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Person).WithOne(t => t.Employee).HasForeignKey<Employee>(t => t.EmployeeId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapEmployeeDepartmentHistory(EntityTypeBuilder<EmployeeDepartmentHistory> config)
		{
			...
			config.Property(t => t.EndDate);
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Department).WithMany(t => t.EmployeeDepartmentHistories).HasForeignKey(t => t.DepartmentId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.Employee).WithMany(t => t.EmployeeDepartmentHistories).HasForeignKey(t => t.EmployeeId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.Shift).WithMany(t => t.EmployeeDepartmentHistories).HasForeignKey(t => t.ShiftId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapEmployeePayHistory(EntityTypeBuilder<EmployeePayHistory> config)
		{
			...
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Employee).WithMany(t => t.EmployeePayHistories).HasForeignKey(t => t.EmployeeId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapJobCandidate(EntityTypeBuilder<JobCandidate> config)
		{
			...
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Employee).WithMany(t => t.JobCandidates).HasForeignKey(t => t.EmployeeId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapPassword(EntityTypeBuilder<Password> config)
		{
			...
			config.Property(t => t.Rowguid).HasColumnName("rowguid");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Person).WithOne(t => t.Password).HasForeignKey<Password>(t => t.BusinessEntityId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapPerson(EntityTypeBuilder<Person> config)
		{
			...
			config.Property(t => t.Rowguid).HasColumnName("rowguid");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.BusinessEntity).WithOne(t => t.Person).HasForeignKey<Person>(t => t.BusinessEntityId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapPersonPhone(EntityTypeBuilder<PersonPhone> config)
		{
			...
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Person).WithMany(t => t.PersonPhones).HasForeignKey(t => t.BusinessEntityId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.PhoneNumberType).WithMany(t => t.PersonPhones).HasForeignKey(t => t.PhoneNumberTypeId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapProduct(EntityTypeBuilder<Product> config)
		{
			...
			config.Property(t => t.Rowguid).HasColumnName("rowguid");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.ProductModel).WithMany(t => t.Products).HasForeignKey(t => t.ProductModelId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.ProductSubcategory).WithMany(t => t.Products).HasForeignKey(t => t.ProductSubcategoryId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.UnitMeasure).WithMany(t => t.Products).HasForeignKey(t => t.SizeUnitMeasureCode).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.UnitMeasure_).WithMany(t => t.Products_).HasForeignKey(t => t.WeightUnitMeasureCode).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapProductCostHistory(EntityTypeBuilder<ProductCostHistory> config)
		{
			...
			config.Property(t => t.StandardCost).HasColumnType("money");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Product).WithMany(t => t.ProductCostHistories).HasForeignKey(t => t.ProductId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapProductDocument(EntityTypeBuilder<ProductDocument> config)
		{
			...
			config.Property(t => t.DocumentNode).HasMaxLength(892);
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Document).WithMany(t => t.ProductDocuments).HasForeignKey(t => t.DocumentNode).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.Product).WithMany(t => t.ProductDocuments).HasForeignKey(t => t.ProductId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapProductInventory(EntityTypeBuilder<ProductInventory> config)
		{
			...
			config.Property(t => t.Rowguid).HasColumnName("rowguid");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Location).WithMany(t => t.ProductInventories).HasForeignKey(t => t.LocationId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.Product).WithMany(t => t.ProductInventories).HasForeignKey(t => t.ProductId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapProductListPriceHistory(EntityTypeBuilder<ProductListPriceHistory> config)
		{
			...
			config.Property(t => t.ListPrice).HasColumnType("money");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Product).WithMany(t => t.ProductListPriceHistories).HasForeignKey(t => t.ProductId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapProductModelIllustration(EntityTypeBuilder<ProductModelIllustration> config)
		{
			...
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Illustration).WithMany(t => t.ProductModelIllustrations).HasForeignKey(t => t.IllustrationId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.ProductModel).WithMany(t => t.ProductModelIllustrations).HasForeignKey(t => t.ProductModelId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapProductModelProductDescriptionCulture(EntityTypeBuilder<ProductModelProductDescriptionCulture> config)
		{
			...
			config.Property(t => t.CultureId).HasColumnName("CultureID").HasMaxLength(6);
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Culture).WithMany(t => t.ProductModelProductDescriptionCultures).HasForeignKey(t => t.CultureId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.ProductDescription).WithMany(t => t.ProductModelProductDescriptionCultures).HasForeignKey(t => t.ProductDescriptionId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.ProductModel).WithMany(t => t.ProductModelProductDescriptionCultures).HasForeignKey(t => t.ProductModelId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapProductProductPhoto(EntityTypeBuilder<ProductProductPhoto> config)
		{
			...
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Product).WithMany(t => t.ProductProductPhotos).HasForeignKey(t => t.ProductId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.ProductPhoto).WithMany(t => t.ProductProductPhotos).HasForeignKey(t => t.ProductPhotoId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapProductReview(EntityTypeBuilder<ProductReview> config)
		{
			...
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Product).WithMany(t => t.ProductReviews).HasForeignKey(t => t.ProductId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapProductSubcategory(EntityTypeBuilder<ProductSubcategory> config)
		{
			...
			config.Property(t => t.Rowguid).HasColumnName("rowguid");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.ProductCategory).WithMany(t => t.ProductSubcategories).HasForeignKey(t => t.ProductCategoryId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapProductVendor(EntityTypeBuilder<ProductVendor> config)
		{
			...
			config.Property(t => t.UnitMeasureCode).HasMaxLength(3).IsRequired();
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Product).WithMany(t => t.ProductVendors).HasForeignKey(t => t.ProductId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.UnitMeasure).WithMany(t => t.ProductVendors).HasForeignKey(t => t.UnitMeasureCode).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.Vendor).WithMany(t => t.ProductVendors).HasForeignKey(t => t.VendorId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapPurchaseOrderDetail(EntityTypeBuilder<PurchaseOrderDetail> config)
		{
			...
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Product).WithMany(t => t.PurchaseOrderDetails).HasForeignKey(t => t.ProductId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.PurchaseOrderHeader).WithMany(t => t.PurchaseOrderDetails).HasForeignKey(t => t.PurchaseOrderId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapPurchaseOrderHeader(EntityTypeBuilder<PurchaseOrderHeader> config)
		{
			...
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Employee).WithMany(t => t.PurchaseOrderHeaders).HasForeignKey(t => t.EmployeeId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.ShipMethod).WithMany(t => t.PurchaseOrderHeaders).HasForeignKey(t => t.ShipMethodId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.Vendor).WithMany(t => t.PurchaseOrderHeaders).HasForeignKey(t => t.VendorId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapSalesOrderDetail(EntityTypeBuilder<SalesOrderDetail> config)
		{
			...
			config.HasOne(t => t.SpecialOfferProduct).WithMany(t => t.SalesOrderDetails).HasForeignKey(t => new { t.ProductId, t.SpecialOfferId }).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapSalesOrderHeader(EntityTypeBuilder<SalesOrderHeader> config)
		{
			...
			config.Property(t => t.Rowguid).HasColumnName("rowguid");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Address).WithMany(t => t.SalesOrderHeaders).HasForeignKey(t => t.BillToAddressId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.Address_).WithMany(t => t.SalesOrderHeaders_).HasForeignKey(t => t.ShipToAddressId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.CreditCard).WithMany(t => t.SalesOrderHeaders).HasForeignKey(t => t.CreditCardId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.CurrencyRate).WithMany(t => t.SalesOrderHeaders).HasForeignKey(t => t.CurrencyRateId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.Customer).WithMany(t => t.SalesOrderHeaders).HasForeignKey(t => t.CustomerId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.SalesPerson).WithMany(t => t.SalesOrderHeaders).HasForeignKey(t => t.SalesPersonId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.SalesTerritory).WithMany(t => t.SalesOrderHeaders).HasForeignKey(t => t.TerritoryId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.ShipMethod).WithMany(t => t.SalesOrderHeaders).HasForeignKey(t => t.ShipMethodId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapSalesOrderHeaderSalesReason(EntityTypeBuilder<SalesOrderHeaderSalesReason> config)
		{
			...
			config.HasOne(t => t.SalesReason).WithMany(t => t.SalesOrderHeaderSalesReasons).HasForeignKey(t => t.SalesReasonId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapSalesPerson(EntityTypeBuilder<SalesPerson> config)
		{
			...
			config.Property(t => t.Rowguid).HasColumnName("rowguid");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Employee).WithOne(t => t.SalesPerson).HasForeignKey<SalesPerson>(t => t.SalesPersonId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.SalesTerritory).WithMany(t => t.SalesPeople).HasForeignKey(t => t.TerritoryId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapSalesPersonQuotaHistory(EntityTypeBuilder<SalesPersonQuotaHistory> config)
		{
			...
			config.Property(t => t.Rowguid).HasColumnName("rowguid");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.SalesPerson).WithMany(t => t.SalesPersonQuotaHistories).HasForeignKey(t => t.SalesPersonId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapSalesTaxRate(EntityTypeBuilder<SalesTaxRate> config)
		{
			...
			config.Property(t => t.Rowguid).HasColumnName("rowguid");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.StateProvince).WithMany(t => t.SalesTaxRates).HasForeignKey(t => t.StateProvinceId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapSalesTerritory(EntityTypeBuilder<SalesTerritory> config)
		{
			...
			config.Property(t => t.Rowguid).HasColumnName("rowguid");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.CountryRegion).WithMany(t => t.SalesTerritories).HasForeignKey(t => t.CountryRegionCode).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapSalesTerritoryHistory(EntityTypeBuilder<SalesTerritoryHistory> config)
		{
			...
			config.Property(t => t.Rowguid).HasColumnName("rowguid");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.SalesPerson).WithMany(t => t.SalesTerritoryHistories).HasForeignKey(t => t.SalesPersonId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.SalesTerritory).WithMany(t => t.SalesTerritoryHistories).HasForeignKey(t => t.TerritoryId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapShoppingCartItem(EntityTypeBuilder<ShoppingCartItem> config)
		{
			...
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Product).WithMany(t => t.ShoppingCartItems).HasForeignKey(t => t.ProductId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapSpecialOfferProduct(EntityTypeBuilder<SpecialOfferProduct> config)
		{
			...
			config.Property(t => t.Rowguid).HasColumnName("rowguid");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Product).WithMany(t => t.SpecialOfferProducts).HasForeignKey(t => t.ProductId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.SpecialOffer).WithMany(t => t.SpecialOfferProducts).HasForeignKey(t => t.SpecialOfferId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapStateProvince(EntityTypeBuilder<StateProvince> config)
		{
			...
			config.Property(t => t.Rowguid).HasColumnName("rowguid");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.CountryRegion).WithMany(t => t.StateProvinces).HasForeignKey(t => t.CountryRegionCode).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.SalesTerritory).WithMany(t => t.StateProvinces).HasForeignKey(t => t.TerritoryId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapStore(EntityTypeBuilder<Store> config)
		{
			...
			config.Property(t => t.Rowguid).HasColumnName("rowguid");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.BusinessEntity).WithOne(t => t.Store).HasForeignKey<Store>(t => t.CustomerId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.SalesPerson).WithMany(t => t.Stores).HasForeignKey(t => t.SalesPersonId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapTransactionHistory(EntityTypeBuilder<TransactionHistory> config)
		{
			...
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Product).WithMany(t => t.TransactionHistories).HasForeignKey(t => t.ProductId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapVendor(EntityTypeBuilder<Vendor> config)
		{
			...
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.BusinessEntity).WithOne(t => t.Vendor).HasForeignKey<Vendor>(t => t.VendorId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapWorkOrder(EntityTypeBuilder<WorkOrder> config)
		{
			...
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Product).WithMany(t => t.WorkOrders).HasForeignKey(t => t.ProductId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.ScrapReason).WithMany(t => t.WorkOrders).HasForeignKey(t => t.ScrapReasonId).OnDelete(DeleteBehavior.NoAction);
		}
		...
		protected virtual void MapWorkOrderRouting(EntityTypeBuilder<WorkOrderRouting> config)
		{
			...
			config.Property(t => t.ActualCost).HasColumnType("money");
			config.Property(t => t.ModifiedDate);
			config.HasOne(t => t.Location).WithMany(t => t.WorkOrderRoutings).HasForeignKey(t => t.LocationId).OnDelete(DeleteBehavior.NoAction);
			config.HasOne(t => t.WorkOrder).WithMany(t => t.WorkOrderRoutings).HasForeignKey(t => t.WorkOrderId).OnDelete(DeleteBehavior.NoAction);
		}
	}
