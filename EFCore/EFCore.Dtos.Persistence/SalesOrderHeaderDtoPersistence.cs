...
namespace EFCore.Dtos.Persistence
{
	...
	public static partial class SalesOrderHeaderPersistence
	{
		...
		/// <summary>Extension method which produces a projection to EFCore.Dtos.DtoClasses.SalesOrderHeaderDto which instances are projected from the results of the specified baseQuery, which returns EFCore.Bencher.EntityClasses.SalesOrderHeader instances, the root entity of the derived element returned by this query.</summary>
		...
		/// <summary>Extension method which produces a projection to EFCore.Dtos.DtoClasses.SalesOrderHeaderDto which instances are projected from the EFCore.Bencher.EntityClasses.SalesOrderHeader entity instance specified, the root entity of the derived element returned by this method.</summary>
